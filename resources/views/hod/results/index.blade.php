...
<div class="card">
    ...
    <div class="card-body">
        @if($departmentId)
            @if($results->count() > 0)
                <form id="hod-bulk-form" method="POST" action="">
                    @csrf
                    ...
                    <div class="d-flex flex-wrap gap-2 align-items-center mb-3 p-2 bg-light border rounded">
                        ...
                        <input type="hidden" name="result_ids" id="hod-result-ids" value="">
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('hod-bulk-form');
    if (!form) return;
    ...
    const idsEl = document.getElementById('hod-result-ids');
    ...
    approveBtn.addEventListener('click', function() {
        ...
        form.action = '{{ route('hod.results.bulkApprove') }}';
        form.submit();
    });
    ...
    rejectBtn.addEventListener('click', function() {
        ...
        form.action = '{{ route('hod.results.bulkReject') }}';
        form.submit();
    });
});
</script>
