        ...
        <form method="POST" action="{{ route('admin.programmes.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="code" value="{{ old('code') }}"
                           class="form-control @error('code') is-invalid @enderror" required maxlength="20">
                ...
                <div class="col-md-6">
                    ...
                    <select name="department_id" class="form-select @error('department_id') is-invalid @enderror">
                        ...
                        @foreach($departments as $id => $name)
                            <option value="{{ $id }}" {{ (string) old('department_id') === (string) $id ? 'selected' : '' }}>
                                {{ $name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i>Create Programme
                </button>
