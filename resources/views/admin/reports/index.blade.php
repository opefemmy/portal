    ...
    <div class="col-md-6 col-xl-3 mb-3">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <a href="{{ route('admin.reports.results') }}" class="btn btn-success">View Report</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3 mb-3">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <a href="{{ route('admin.reports.payments') }}" class="btn btn-warning">View Report</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3 mb-3">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <a href="{{ route('admin.course-assignments.index') }}" class="btn btn-info">View Report</a>
            </div>
        </div>
    </div>
</div>
