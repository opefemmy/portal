<?php $__env->startSection('title', 'Applicant Registration'); ?>
    ...
    <div class="register-card">
        ...
        <div class="register-body">
            ...
            <div class="text-center mt-3">
                <a href="<?php echo e(route('login')); ?>" class="text-primary">Already have an account? Login</a>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\OneDrive\Documents\Portal\resources\views/auth/applicant-register.blade.php ENDPATH**/ ?>